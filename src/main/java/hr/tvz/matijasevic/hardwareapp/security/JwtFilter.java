package hr.tvz.matijasevic.hardwareapp.security;


import hr.tvz.matijasevic.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        Boolean b = SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
